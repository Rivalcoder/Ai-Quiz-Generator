  ...
  try {
    ...
    const { object } = await generateObject({
      ...
      prompt: `
        ...
        2) At maximum 10 quiz questions that test understanding of the code's functionality, structure, and concepts
            (Question Should first Give the Code and Ask What is the Use of this Line Like that Not Ask What is Use of this file Like)
        For each question:
